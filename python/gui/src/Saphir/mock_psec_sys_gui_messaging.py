...
class MockPSECSysGuiMessaging():
    dom0_socket = None
    dom0_socket_path = ""    

    def start(self, sockets_path:str):
        self.dom0_socket_path = "{}/sys-gui-msg.sock".format(sockets_path)
        
        print("Opening sys-gui@Dom0 messaging socket at {}".format(self.dom0_socket_path))        
    ...
    def __monitor_socket(self):
        while True:
            ...
            print(f"Connection received on Dom0 sys-gui messaging socket")
            ...
            try:
                while True:
                    ...
                    print("DEBUG - Received {} bytes on Dom0 sys-gui messaging socket".format(len(data)))
